...
public class Player1 : MonoBehaviour
{
    ...
    {
        if (this.gameObject.name == "Suzuki1P(Clone)")
        {
            myCharName1P = "suzuki";
        }
        if (this.gameObject.name == "Yokoyama1P(Clone)")
        {
            myCharName1P = "yokoyama";
        }
        if (this.gameObject.name == "Niduma1P(Clone)")
        {
            myCharName1P = "niduma";
        }
        if (this.gameObject.name == "LUO1P(Clone)")
        {
            myCharName1P = "LUO";
        }
    }
    ...
    private void SkillOne()
    {
        ...
        {
            case "suzuki":
                if (SkillR1P == true && this.transform.position.x < maxMove.x - moveX.x * 2)
                {
                    moveAfter1P = transform.position + moveX * 2;
                    SoundManager.Instance.PlaySe(SE.SuzukiS1);
                }
                else if (SkillR1P == false && minMove.x + moveX.x * 2 < this.transform.position.x)
                {
                    moveAfter1P = transform.position - moveX * 2;
                    SoundManager.Instance.PlaySe(SE.SuzukiS1);
                }
